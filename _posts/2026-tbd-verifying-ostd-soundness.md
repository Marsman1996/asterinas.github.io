...
After more than a year of development, where does OSTD soundness stand? We have proven defined behavior for a significant subset of the [`mm`](https://asterinas.github.io/vostd/ostd/mm/index.html) module, as well as correctness properties. The CortenMM project has verified concurrent corrections of the page table's fine-grained locking mechanism. We are now expanding into the [`sync`](https://asterinas.github.io/vostd/ostd/sync/index.html) module for more concurrency verification. Documentation of the verified APIs is already available [online](https://asterinas.github.io/vostd/ostd/index.html), and it continues to grow.
